      ...
      <div className="footer-meta">
          ...
          <div className="footer-meta-col">
            <div className="footer-meta-block">
              <div className="footer-meta-logo">
                <Copy delay={0.1}>
                <img src="/logos/influence-logo-brand.png" alt="Influence Brand Agency" />
                </Copy>
              </div>
              <Copy delay={0.2}>
                <h2>Muslim influence matters. We prove it every day.</h2>
              </Copy>
            </div>
          </div>
          <div className="footer-meta-col">
        ...
        <div className="container footer-socials">
          ...
          <div className="footer-meta-col">
            <Copy delay={0.1}>
              <p>
              We turn Muslim influence into market power. Let's build something that matters.
              </p>
            </Copy>
          </div>
        </div>
      ...
      <div className="footer-outro">
        <div className="container">
          ...
          <div className="footer-copyright">
            <p>
              Developed by — <span>AdLens Digital, LLC</span>
            </p>
